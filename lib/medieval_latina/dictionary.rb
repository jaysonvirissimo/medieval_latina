...
class MedievalLatina
  ...
  FREQUENCY_LIST = {
    ...
    "-a" => {meaning: "great", part: "Adjective", declensions:  ["1st",  "2nd"]},
    "-um" => {meaning: "great", part: "Adjective", declensions:  ["1st",  "2nd"]},
    "ex" => {meaning: "out of, from (+ abl.)", part: "Preposition"},
    "ē" => {meaning: "out of, from (+ abl.)", part: "Preposition"},
    "suus" => {meaning: "his own, her own, its own", part: "Adjective", declensions:  ["1st",  "2nd"]},
    "sua" => {meaning: "his own, her own, its own", part: "Adjective", declensions:  ["1st",  "2nd"]},
    "suum" => {meaning: "his own, her own, its own", part: "Adjective", declensions:  ["1st",  "2nd"]},
    ...
    "super" => {meaning: "over", part: "Preposition", usage: "+acc."},
