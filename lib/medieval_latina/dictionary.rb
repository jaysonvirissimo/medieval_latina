...
class MedievalLatina
  ...
  FREQUENCY_LIST = {
    ...
    "in" => {meaning: "in, on (+ablative); into, onto (+accusative)", part: "Preposition"},
    ...
    "ex" => {meaning: "out of, from (+ablative)", part: "Preposition"},
    "ē" => {meaning: "out of, from (+ablative)", part: "Preposition"},
    ...
    "vis" => {meaning: "force; (acc.) vim, (abl.) vi; (pl.) vires, strength", part: "Noun", gender: :feminine, declension: "3rd"},
    ...
    "ūtor" => {meaning: "use, consume, employ (+ablative)", part: "Verb"},
    "ūtī" => {meaning: "use, consume, employ (+ablative)", part: "Verb"},
    "ūsus" => {meaning: "use, consume, employ (+ablative)", part: "Verb"},
    ...
    "parcō" => {meaning: "spare, be sparing of (+ dat.)", part: "Verb", conjugation: "3rd"},
    "parcere" => {meaning: "spare, be sparing of (+ dat.)", part: "Verb", conjugation: "3rd"},
    ...
    "mīror" => {meaning: "wonder at, marvel at (+ acc.)", part: "Verb"},
    "mīrārī" => {meaning: "wonder at, marvel at (+ acc.)", part: "Verb"},
    ...
    "careō" => {meaning: "lack (+ablative)", part: "Verb", conjugation: "2nd"},
    "carēre" => {meaning: "lack (+ablative)", part: "Verb", conjugation: "2nd"},
    "caruī" => {meaning: "lack (+ablative)", part: "Verb", conjugation: "2nd"},
    ...
    "intrā" => {meaning: "within (+ acc.)", part: "Preposition"},
    ...
    "decet" => {meaning: "it is right, proper, fitting (+ acc. + infin.)", part: "Verb"},
    "decēre" => {meaning: "it is right, proper, fitting (+ acc. + infin.)", part: "Verb"},
    "decuīt" => {meaning: "it is right, proper, fitting (+ acc. + infin.)", part: "Verb"},
    ...
    "ēgredior" => {meaning: "stride out, depart, disembark from (+ablative)", part: "Verb", conjugation: "Deponent"},
    "ēgredī" => {meaning: "stride out, depart, disembark from (+ablative)", part: "Verb", conjugation: "Deponent"},
    "ēgressus" => {meaning: "stride out, depart, disembark from (+ablative)", part: "Verb", conjugation: "Deponent"},
    ...
    "fruor" => {meaning: "enjoy the produce of, profit by, use (+ablative)", part: "Verb", conjugation: "Deponent"},
    "fruī" => {meaning: "enjoy the produce of, profit by, use (+ablative)", part: "Verb", conjugation: "Deponent"},
    "frūctus" => {meaning: "enjoy the produce of, profit by, use (+ablative)", part: "Verb", conjugation: "Deponent"},
    ...
    "afficiō" => {meaning: "affect, visit with (+ablative)", part: "Verb", conjugation: "3rd -iō"},
    "afficere" => {meaning: "affect, visit with (+ablative)", part: "Verb", conjugation: "3rd -iō"},
    "affēcī" => {meaning: "affect, visit with (+ablative)", part: "Verb", conjugation: "3rd -iō"},
    "affectum" => {meaning: "affect, visit with (+ablative)", part: "Verb", conjugation: "3rd -iō"},
