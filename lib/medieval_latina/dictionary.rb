...
class MedievalLatina
  ...
  FREQUENCY_LIST = {
    ...
    "libet" => {meaning: "it is pleasing (+ dat. + infin.)", part: "Verb", conjugation: "Impersonal"},
    "libēre" => {meaning: "it is pleasing (+ dat. + infin.)", part: "Verb", conjugation: "Impersonal"},
    "libuit" => {meaning: "it is pleasing (+ dat. + infin.)", part: "Verb", conjugation: "Impersonal"},
    "libitum est" => {meaning: "it is pleasing (+ dat. + infin.)", part: "Verb", conjugation: "Impersonal"},
    "centum" => {meaning: "one hundred", part: "Adjective", type: "Numeral"},
    "cōnstō" => {meaning: "agree; constat, it is established that (+ acc. and infin.)", part: "Verb", conjugation: "1st"},
    "cōnstāre" => {meaning: "agree; constat, it is established that (+ acc. and infin.)", part: "Verb", conjugation: "1st"},
    "cōnstitī" => {meaning: "agree; constat, it is established that (+ acc. and infin.)", part: "Verb", conjugation: "1st"},
    ...
    "circā" => {meaning: "around (adv. and prep. +acc.)", part: "Preposition", category: "Place"},
    "ōrātiō" => {meaning: "speech, address", part: "Noun", declension: "3rd", category: "Speech/Oratory"},
    "ōrātiōnis" => {meaning: "speech, address", part: "Noun", declension: "3rd", category: "Speech/Oratory"},
    "potestās" => {meaning: "power", part: "Noun", declension: "3rd", category: "The City"},
    "potestātis" => {meaning: "power", part: "Noun", declension: "3rd", category: "The City"},
    "tardus" => {meaning: "slow, sluggish, lingering", part: "Adjective", declension: "1st and 2nd", category: "Time"},
    "tarda" => {meaning: "slow, sluggish, lingering", part: "Adjective", declension: "1st and 2nd", category: "Time"},
    "tardum" => {meaning: "slow, sluggish, lingering", part: "Adjective", declension: "1st and 2nd", category: "Time"},
    "for" => {meaning: "report, say", part: "Verb", conjugation: "Deponent", category: "Speech/Oratory"},
    "fārī" => {meaning: "report, say", part: "Verb", conjugation: "Deponent", category: "Speech/Oratory"},
    "fātus sum" => {meaning: "report, say", part: "Verb", conjugation: "Deponent", category: "Speech/Oratory"},
    "humus" => {meaning: "ground; humī: on the ground", part: "Noun", declension: "2nd", category: "Earth and Water"},
    "humī" => {meaning: "ground; humī: on the ground", part: "Noun", declension: "2nd", category: "Earth and Water"},
    "testis" => {meaning: "witness", part: "Noun", declension: "3rd", category: "Justice"},
    "testis" => {meaning: "witness", part: "Noun", declension: "3rd", category: "Justice"},
    ...
    "cūrō" => {meaning: "watch over, look after, care for (+ acc.)", part: "Verb", conjugation: "1st"},
    "cūrāre" => {meaning: "watch over, look after, care for (+ acc.)", part: "Verb", conjugation: "1st"},
    ...
    "prōcēdō" => {meaning: "go forth, advance", part: "Verb", conjugation: "3rd -ō"},
    "prōcēdere" => {meaning: "go forth, advance", part: "Verb", conjugation: "3rd -ō"},
    "prōcessī" => {meaning: "go forth, advance", part: "Verb", conjugation: "3rd -ō"},
    "prōcessum" => {meaning: "go forth, advance", part: "Verb", conjugation: "3rd -ō"},
    ...
    "praeter" => {meaning: "by, along, past; besides, except (+ acc.)", part: "Preposition"},
    "cōnsulō" => {meaning: "consult, plan (+ acc.); consider the interests of (+dat)", part: "Verb", conjugation: "3rd"},
    "cōnsulere" => {meaning: "consult, plan (+ acc.); consider the interests of (+dat)", part: "Verb", conjugation: "3rd"},
    "cōnsuluī" => {meaning: "consult, plan (+ acc.); consider the interests of (+dat)", part: "Verb", conjugation: "3rd"},
    "cōnsultum" => {meaning: "consult, plan (+ acc.); consider the interests of (+dat)", part: "Verb", conjugation: "3rd"},
    "iterum" => {meaning: "again", part: "Adverb"},
    "porta" => {meaning: "gate", part: "Noun", declension: "1st"},
    "portae" => {meaning: "gate", part: "Noun", declension: "1st"},
    "intersum" => {meaning: "to be between; take part in, attend (+dat.); interest, it is in the interest of (+ gen.)", part: "Verb", conjugation: "Irregular"},
    "interesse" => {meaning: "to be between; take part in, attend (+dat.); interest, it is in the interest of (+ gen.)", part: "Verb", conjugation: "Irregular"},
    "interfuī" => {meaning: "to be between; take part in, attend (+dat.); interest, it is in the interest of (+ gen.)", part: "Verb", conjugation: "Irregular"},
    ...
    "necesse" => {meaning: "necessary", part: "Adjective", type: "Indeclinable"},
    "reor" => {meaning: "think, imagine, suppose, deem", part: "Verb", type: "Deponent"},
    "rērī" => {meaning: "think, imagine, suppose, deem", part: "Verb", type: "Deponent"},
    "rātus" => {meaning: "think, imagine, suppose, deem", part: "Verb", type: "Deponent"},
    "rāta" => {meaning: "think, imagine, suppose, deem", part: "Verb", type: "Deponent"},
    "rātum" => {meaning: "think, imagine, suppose, deem", part: "Verb", type: "Deponent"},
    ...
    "licet" => {meaning: "even though", part: "Conjunction"},
    ...
    "cōnstitī" => {meaning: "take position; consist in, be composed of", part: "Verb", conjugation: "3rd"},
    ...
    "probō" => {meaning: "approve, prove; convince one (dat.) of a thing (acc.)", part: "Verb", conjugation: "1st"},
    "probāre" => {meaning: "approve, prove; convince one (dat.) of a thing (acc.)", part: "Verb", conjugation: "1st"},
    ...
    "cor" => {meaning: "heart; cordī est, it is pleasing to (+ dat.)", part: "Noun", declension: "3rd"},
    "cordis" => {meaning: "heart; cordī est, it is pleasing to (+ dat.)", part: "Noun", declension: "3rd"},
    ...
    "nimium" => {meaning: "excessively", part: "Adverb"},
    ...
    "quattuor" => {meaning: "four", part: "Adjective", type: "Numeral"},
    ...
    "serviō" => {meaning: "be a slave, serve", part: "Verb", conjugation: "4th", usage: "+ dat."},
    "servīre" => {meaning: "be a slave, serve", part: "Verb", conjugation: "4th", usage: "+ dat."},
    "vereor" => {meaning: "fear, stand in awe of", part: "Verb", type: "Deponent", conjugation: nil},
    "verērī" => {meaning: "fear, stand in awe of", part: "Verb", type: "Deponent", conjugation: nil},
    "ingredior" => {meaning: "step in, enter", part: "Verb", type: "Deponent", conjugation: nil},
    "ingredī" => {meaning: "step in, enter", part: "Verb", type: "Deponent", conjugation: nil},
    "addūcō" => {meaning: "lead to, induce", part: "Verb", conjugation: "3rd -ō"},
    "addūcere" => {meaning: "lead to, induce", part: "Verb", conjugation: "3rd -ō"},
    "hortor" => {meaning: "urge strongly, advise, exhort", part: "Verb", type: "Deponent", conjugation: nil},
    "hortārī" => {meaning: "urge strongly, advise, exhort", part: "Verb", type: "Deponent", conjugation: nil},
    "reus" => {meaning: "defendant", part: "Noun", declension: "2nd"},
    "reī" => {meaning: "defendant", part: "Noun", declension: "2nd"},
    "scīlicet" => {meaning: "certainly, of course", part: "Adverb", category: "Conjunctions/Adverbs"},
    ...
    "intendō" => {meaning: "stretch out, strain", part: "Verb", conjugation: "3rd -ō"},
    "intendere" => {meaning: "stretch out, strain", part: "Verb", conjugation: "3rd -ō"},
    ...
    "sōlum" => {meaning: "only, merely", part: "Adverb", category: "Measurement"},
    ...
    "prōtinus" => {meaning: "at once, forthwith", part: "Adverb", category: "Time"},
    ...
    "ēgredior" => {meaning: "stride out, depart, disembark from (+ abl.)", part: "Verb", conjugation: "Deponent"},
    "ēgredī" => {meaning: "stride out, depart, disembark from (+ abl.)", part: "Verb", conjugation: "Deponent"},
    "ēgressus" => {meaning: "stride out, depart, disembark from (+ abl.)", part: "Verb", conjugation: "Deponent"},
    "poēta" => {meaning: "poet", part: "Noun", declension: "1st"},
    "poētae" => {meaning: "poet", part: "Noun", declension: "1st"},
    "decem" => {meaning: "ten", part: "Adjective", type: "Numeral"},
    ...
    "fruor" => {meaning: "enjoy the produce of, profit by, use (+ abl.)", part: "Verb", conjugation: "Deponent"},
    "fruī" => {meaning: "enjoy the produce of, profit by, use (+ abl.)", part: "Verb", conjugation: "Deponent"},
    "frūctus" => {meaning: "enjoy the produce of, profit by, use (+ abl.)", part: "Verb", conjugation: "Deponent"},
    ...
    "interrogō" => {meaning: "put a question to, ask (+ acc.)", part: "Verb", conjugation: "1st"},
    "interrogāre" => {meaning: "put a question to, ask (+ acc.)", part: "Verb", conjugation: "1st"},
    ...
    "afficiō" => {meaning: "affect, visit with (+ abl.)", part: "Verb", conjugation: "3rd -iō"},
    "afficere" => {meaning: "affect, visit with (+ abl.)", part: "Verb", conjugation: "3rd -iō"},
    "affēcī" => {meaning: "affect, visit with (+ abl.)", part: "Verb", conjugation: "3rd -iō"},
    "affectum" => {meaning: "affect, visit with (+ abl.)", part: "Verb", conjugation: "3rd -iō"},
    ...
    "arbitror" => {meaning: "consider, think", part: "Verb", type: "Deponent"},
    "arbitrārī" => {meaning: "consider, think", part: "Verb", type: "Deponent"},
    "arbitrātus" => {meaning: "consider, think", part: "Verb", type: "Deponent"},
    ...
    "quiēscō" => {meaning: "keep quiet; sleep", part: "Verb", conjugation: "3rd -ō"},
    "quiēscere" => {meaning: "keep quiet; sleep", part: "Verb", conjugation: "3rd -ō"},
    "quiēvī" => {meaning: "keep quiet; sleep", part: "Verb", conjugation: "3rd -ō"},
    "quiētum" => {meaning: "keep quiet; sleep", part: "Verb", conjugation: "3rd -ō"},
    ...
    "cōnfiteor" => {meaning: "admit (a fact), confess (a crime); reveal, disclose", part: "Verb", type: "Deponent"},
    "cōnfitērī" => {meaning: "admit (a fact), confess (a crime); reveal, disclose", part: "Verb", type: "Deponent"},
    "cōnfessus" => {meaning: "admit (a fact), confess (a crime); reveal, disclose", part: "Verb", type: "Deponent"},
    "dīligō" => {meaning: "choose, cherish, love", part: "Verb", conjugation: "3rd -ō"},
    "dīligere" => {meaning: "choose, cherish, love", part: "Verb", conjugation: "3rd -ō"},
    "dīlēxī" => {meaning: "choose, cherish, love", part: "Verb", conjugation: "3rd -ō"},
    "dīlēctum" => {meaning: "choose, cherish, love", part: "Verb", conjugation: "3rd -ō"},
    "plērumque" => {meaning: "generally", part: "Adverb"},
    ...
    "adversum" => {meaning: "turn towards", part: "Verb", conjugation: "3rd"},
    ...
    "mundus" => {meaning: "clean, neat, elegant", part: "Adjective", declension: "1st and 2nd"},
